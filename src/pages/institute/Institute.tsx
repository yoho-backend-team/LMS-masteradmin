...
const Institutes: React.FC = () => {
  ...
  const activeCount = instituteData.filter(
    (item: any) => item.Institute_Status === "active"
  ).length;
  const inactiveCount = instituteData.filter(
    (item: any) => item.Institute_Status === "inactive"
  ).length;
