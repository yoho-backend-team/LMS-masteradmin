      ...
      <form onSubmit={formik.handleSubmit} className="space-y-6">
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className=" !text-[#242731]" style={{ ...FONTS.tableheader }}>
                Upload Profile Picture
              </p>
              <p
                className="!text-[#242731] opacity-40"
                style={{ ...FONTS.text3 }}
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-2">
            <label className=" !text-[#242731]" style={{ ...FONTS.text5 }}>
              Plan
            </label>
            <Input
              name="plan"
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                formik.setFieldValue("supportLevel", value)
              }
            >
        ...
        >
          ...
          <Button
            type="submit"
            className="bg-[#6bc1a3] px-4 py-2 rounded-tl-xl rounded-br-xl rounded-tr-none rounded-bl-none hover:bg-[#57ab90]"
            style={{ ...FONTS.button }}
