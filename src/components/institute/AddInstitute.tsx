        ...
        const data = {
          institute: {
            ...
            contact_info: {
              ...
              address: {
                ...
                state:
                  states.find((s) => s.iso2 === formData.state)?.name || "",
                city: cities.find((c) => c.iso2 === formData.city)?.name || "",
          ...
          branch: {
            ...
            contact_info: {
              ...
              state:
                branchStates.find((s) => s.iso2 === formData.stateBranch)
                  ?.name || "",
              city:
                branchCities.find((c) => c.iso2 === formData.cityBranch)
                  ?.name || "",
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {states?.length > 0 && (
                  <DropdownField
                    ...
                    onChange={(field, value) => {
                      handleStateChange(value, formData.country);
                      handleInputChange(field, value);
                    }}
                  />
                )}
            ...
            <div className="space-y-6">
                ...
                {formData.gstFile && (
                  <div className="absolute right-15 bottom-22">
                    <p style={{ ...FONTS.small_text }}>
                      {formData.gstFile?.includes("staticfiles/lms")
              ...
              <Card className="p-4 shadow-md relative">
                ...
                {formData.panFile && (
                  <div className="absolute right-15 bottom-22">
                    <p style={{ ...FONTS.small_text }}>
                      {formData.panFile?.includes("staticfiles/lms")
                        ? "file uploaded success"
                        : "upload failed try again.."}
                    </p>
                  </div>
              ...
              <Card className="p-4 shadow-md relative">
                ...
                {formData.licenseFile && (
                  <div className="absolute right-15 bottom-22">
                    <p style={{ ...FONTS.small_text }}>
                      {formData.licenseFile?.includes("staticfiles/lms")
                        ? "file uploaded success"
                        : "upload failed try again.."}
                    </p>
                  </div>
            ...
            <Card className="p-6 shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <DropdownField
                  ...
                  value={formData.country}
                  onChange={(field, value) => {
                    handleCountryChange(value, true);
                    handleInputChange(field, value);
                  }}
                />
