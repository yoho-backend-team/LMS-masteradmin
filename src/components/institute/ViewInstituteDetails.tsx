...
import DocumentsPage, { type InstituteDocs } from "./Documents";
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <Input id="status" placeholder={institute.status.toUpperCase()} />
        </div>
        <div className="space-y-2">
          <Label htmlFor="contact">Contact</Label>
          <Input
            id="contact"
            placeholder={institute?.contact_info?.phone_no || "Not available"}
          />
        </div>
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder={
              institute?.contact_info?.alternate_no || "Not available"
            }
          />
        </div>
        <div className="space-y-2">
          ...
          <Input
            ...
            type="date"
            value={
              new Date(institute.registered_date).toISOString().split("T")[0]
            }
            readOnly
          />
        </div>
    ...
    switch (activeProfileSection) {
      ...
      case "social-media":
        const socialLinks = [
          {
            name: "Facebook",
            url: institute?.social_media?.facebook_id,
            icon: "🌐",
          },
          {
            name: "LinkedIn",
            url: institute?.social_media?.linkedin_id,
            icon: "🌐",
          },
          {
            name: "Instagram",
            url: institute?.social_media?.instagram_id,
            icon: "🌐",
          },
      ...
      case "activity-logs":
        return (
          <div className="p-6">
           ...
           {params.id && <TimelineComponent instituteId={params.id} />}
          </div>
        );
      default:
        return <PersonalInfoForm />;
            ...
            <Card key={course.id} className="max-w-sm">
              <CardHeader className="pb-2">
                <div className="flex items-center gap-2 mb-2">
                  <img
                    src={GetImageUrl(course?.imageUrl ?? "") || courseImg}
