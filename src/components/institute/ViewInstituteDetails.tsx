    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            id="status"
            value={institute.Institute_Status.toUpperCase()}
            readOnly
          />
        </div>
      ...
      <div className="p-6 bg-white shadow-md rounded-lg">
        {!isEditing ? (
          <div className="flex gap-4 mt-6">
            ...
            <Button className="bg-[#2D6974] !text-white hover:bg-[#2D6974]">
              Suspend
            </Button>
          </div>
        ) : (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto no-scrollbar">
