...
import { fileupload, updateProfile } from "@/features/Profile/services";
  ...
  return (
    <div className="grid gap-4 animate-pulse">
      ...
      <div className="shadow-[0px_0px_15px_0px_#0000001A] p-4 rounded-lg min-h-[250px]">
        ...
        <div className="flex gap-4 overflow-x-scroll scrollbar-hidden p-3 my-3 no-scrollbar">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="shadow-[0px_0px_15px_0px_#0000001A] min-w-[400px] rounded-lg p-4"
            >
  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="shadow-[0px_0px_15px_0px_#0000001A] p-4 rounded-lg min-h-[250px] overflow-x-auto scrollbar-hidden">
        ...
        <div className="flex gap-4 overflow-x-scroll  p-3 my-3 no-scrollbar ">
